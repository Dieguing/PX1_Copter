...
#                '-Werror=shorten-64-to-32',  # ARRAY_SIZE() creates this all over the place as the caller typically takes a uint32_t not a size_t
    ...
    def build(self, bld):
        ...
        bld.ap_version_append_str('GIT_VERSION', "0x04")
        bld.ap_version_append_int('GIT_VERSION_INT', int("0x02", base=16))
...
class chibios(Board):
    ...
    def build(self, bld):
        ...
        bld.ap_version_append_str('CHIBIOS_GIT_VERSION', "0x03")
